...
The **CAP Theorem**, proposed by Eric Brewer in 2000, states that in the design of distributed systems, it is only possible to achieve at most two of the three properties: Consistency (C), Availability (A), and Partition Tolerance (P) simultaneously.
